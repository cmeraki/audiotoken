...
class GPT(nn.Module):
    ...
    def __init__(self, config):
        ...
        logger.info(f"number of parameters: {self.get_num_params()}")
    ...
    def from_pretrained(cls, model_type, weights=None):
        ...
        assert model_type in {'gpt2', 'gpt2-medium', 'gpt2-large', 'gpt2-xl', 'cmeraki/gpt2-124M-400B', 'mdouglas/llmc-gpt2-774M-150B'}
        ...
        config_args = {
            ...
            'mdouglas/llmc-gpt2-774M-150B': dict(n_layer=36, n_head=20, n_embd=1280)
    ...
    def expand_vocab(self, new_vocab_size):
        ...
        logger.info("Updating embeddings", f"{self.config.vocab_size, self.config.n_embd} => {new_vocab_size, self.config.n_embd}")
